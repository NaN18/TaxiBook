...
public class taxibook {
    public static void main(String[] args) {
      ...
      while(true)
      {
      System.out.println("******************************BOOK TAXI HERE*******************************");
      ...
      if(ch==1)
      {
         ...
         if(pick>(char)70)
         {
        	 System.out.println("Taxies not available.....choose location from A to F");
        	 System.out.println("Pickup Point:");
        	 pick=scan.nextLine().charAt(0);
         }
 ...
 class Taxi {
    ...
    public int calculateEarnings(char pick,char drop)
    {
        ...
        int dist=array[l][m];
        System.out.println( "total kms from "+pick+" to "+drop+" is="+dist);
        if(dist==0)
        {
